...
class Post(models.Model):
    ...
    liked_by = models.ManyToManyField(to='user.User', related_name='liked_posts')
    marked_by = models.ManyToManyField(to='user.User', related_name='marked_posts')
...
class Comment(models.Model):
    author = models.ForeignKey('user.User', related_name='user_comments', on_delete=models.CASCADE)
    ...
    liked_by = models.ManyToManyField(to='user.User', related_name='liked_comments')
    disliked_by = models.ManyToManyField(to='user.User', related_name='disliked_comments')
